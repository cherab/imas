...
def test_load_core_plasma(path_iter_jintrac: str):
    ...
    # Test that geometry is set and has the expected type
...
def test_load_core_plasma_with_time(path_iter_jintrac: str):
    ...
    plasma = load_core_plasma(path_iter_jintrac, "r", time=450.0, split_ion_bundles=False)
    assert isinstance(plasma, Plasma)

    with pytest.raises(ValueError):
        load_core_plasma(path_iter_jintrac, "r", time=-1, split_ion_bundles=False)
...
def test_load_core_plasma_with_occurrence(path_iter_jintrac: str):
    ...
    plasma1 = load_core_plasma(path_iter_jintrac, "r", occurrence=0, split_ion_bundles=False)
...
def test_load_core_plasma_with_parent(path_iter_jintrac: str):
    ...
    plasma = load_core_plasma(path_iter_jintrac, "r", parent=world, split_ion_bundles=False)
    assert isinstance(plasma, Plasma)
...
def test_load_core_plasma_with_magnetic_field(path_iter_jintrac: str):
    ...
    try:
        ...
        plasma = load_core_plasma(path_iter_jintrac, "r", b_field=b_field, split_ion_bundles=False)
        assert isinstance(plasma, Plasma)
...
def test_load_core_plasma_time_threshold(path_iter_jintrac: str):
    ...
    plasma = load_core_plasma(path_iter_jintrac, "r", time_threshold=500, split_ion_bundles=False)
    assert isinstance(plasma, Plasma)

    # Test with very small time threshold (should raise error)
    with pytest.raises(RuntimeError):
        load_core_plasma(path_iter_jintrac, "r", time_threshold=0.0, split_ion_bundles=False)


def test_load_core_plasma_not_split_ion_bundles(path_iter_jintrac: str):
